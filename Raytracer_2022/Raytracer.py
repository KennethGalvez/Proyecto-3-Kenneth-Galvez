...
#rtx.scene.append( Sphere(V3(0,0,-13), 0.5, creeper))
#rtx.scene.append( Sphere(V3(0,0,-13), 0.5, steve))

rtx.scene.append( AABB(position = (-1,-3,-11), size = (2,3,2), material = azul))
rtx.scene.append( AABB(position = (-2.5,-3,-11), size = (2,3,2), material = verde))
#Cabeza
rtx.scene.append( Sphere(V3(-1,-1,-11), 1.3, tela))
rtx.scene.append( Sphere(V3(-2.8,-1,-11), 1.3, nubes))
